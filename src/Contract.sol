...
contract NFTRaffleContract {
    ...
    function startRaffle(address _nftContract, uint256 _tokenID) public onlyOwner {
      ...
      require(nftAddress == address(0), 'NFT prixe already set, Please select a winner');
      require(
    ...
    function buyEntry(uint256 _numberOfEntries) public payable {
      require(raffleStatus, "Raffle is not yet started");
      require(msg.value == entryCost * _numberOfEntries, "Incorect amount sent");
